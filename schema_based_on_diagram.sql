...
CREATE INDEX medical_history_id_idx ON medical_histories_and_treatments(medical_history_id);
CREATE INDEX treatment_id_idx ON medical_histories_and_treatments(treatment_id);
